  ...
  return (
    <View style={styles.screenContainer}>
      <View style={[styles.container, styles.border]}>
        ...
        <Image
  source={require('../../assets/images/hero.jpg')} // Sesuaikan path dengan lokasi file
  style={styles.drawerProfileImage}
/>
          <Text style={styles.title}>Ahmad Maulana</Text>
        </View>
        <Text style={styles.text}>NIM: 222505019</Text>
      </View>
...
const AboutMeScreen = () => (
  <View style={styles.screenContainer}>
    <View style={[styles.container, styles.border]}>
      ...
      <Text style={styles.text}>Saya adalah seorang mahasiswa yang suka menggambar dan membuat ilustrasi dan mencoba belajar tentang pemrograman UI/UX.</Text>
    </View>
  </View>
);
...
const HobbiesScreen = () => (
  <View style={styles.screenContainer}>
    <View style={[styles.container, styles.border]}>
      ...
      <Text style={styles.text}>1. Menggambar</Text>
      <Text style={styles.text}>2. Volly</Text>
      <Text style={styles.text}>3. Membaca</Text>
    </View>
  </View>
);
...
const CustomDrawerContent = (props: DrawerContentComponentProps) => (
  ...
  style={styles.drawerProfileImage}
/>
      <Text style={styles.drawerTitle}>Ahmad maulana</Text>
    </View>
